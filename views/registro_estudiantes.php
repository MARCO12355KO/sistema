...
<head>
    ...
    <title>Registro Estudiantes | UNIOR</title>
...
<body>
    ...
    <main class="main-stage">
        ...
        <header class="reveal" style="animation-delay: 0.1s;">
            <h1 class="section-title">
                Nuevo <span class="section-accent">Estudiante.</span>
            </h1>
        </header>
        ...
        <div class="cloud-card reveal" style="animation-delay: 0.2s;">
            <form id="estudianteForm" novalidate>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <label class="form-label">
                                Primer Nombre <span class="required-mark">*</span>
                            </label>
                            <div class="input-group-icon">
                                ...
                                <div class="invalid-feedback">
                                    ...
                                    <span>Por favor ingrese el primer nombre</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">
                                Primer Apellido <span class="required-mark">*</span>
                            </label>
                            <div class="input-group-icon">
                                <input 
                                    type="text" 
                                ...
                                <div class="invalid-feedback">
                                    <i class="fas fa-exclamation-circle"></i>
                                    <span>Por favor ingrese el primer apellido</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <div class="input-group-icon">
                                ...
                                <div class="invalid-feedback">
                                    <i class="fas fa-exclamation-circle"></i>
                                    <span>Número de celular boliviano inválido (debe comenzar con 6 o 7)</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group-icon">
                                ...
                                <div class="invalid-feedback">
                                    <i class="fas fa-exclamation-circle"></i>
                                    <span>Por favor seleccione una carrera</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-3 mt-4">
                    ...
                    <div class="col-md-6">
                        <button type="submit" class="btn-ae" id="btnGuardar">
    ...
    <script>
        ...
        capitalizeInput(document.getElementById('primer_nombre'));
        capitalizeInput(document.getElementById('segundo_nombre'));
        capitalizeInput(document.getElementById('primer_apellido'));
        capitalizeInput(document.getElementById('segundo_apellido'));
            ...
            input.addEventListener('keydown', function(e) {
                ...
                if (e.key === 'Enter') {
                    ...
                    while (nextIndex < formInputs.length) {
                        ...
                        // Si el campo está visible y no está deshabilitado
                        if (!nextInput.disabled && nextInput.offsetParent !== null) {
                            nextInput.focus();
                    ...
                    // Si llegamos al final, hacer focus en el botón de guardar
        ...
        form.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('../controllers/procesar_estudiante.php', {
                    method: 'POST',
                    body: formData
                });
                ...
                if (data.exito) {
                    ...
                    throw new Error(data.mensaje || 'Error al guardar el estudiante');
                }
                ...
                await Swal.fire({
                    ...
                    text: error.message || 'Ocurrió un error. Por favor intente nuevamente.',

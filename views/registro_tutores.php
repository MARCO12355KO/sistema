...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax_save'])) {
    ...
    try {
        ...
        $sqlPersona = "INSERT INTO public.personas (ci, primer_nombre, primer_apellido, segundo_apellido, celular, estado) 
                       VALUES (:ci, :nom, :ape1, :ape2, :cel, 'ACTIVO') 
...
<head>
    ...
    <title>Registro de Tutor - UNIOR</title>
    ...
    <style>
        ...
        * {
        ...
        /* ============== FORM (mismo estilo que registro estudiantes) ============== */
        .form-section {
            margin-bottom: 32px;
            padding-bottom: 32px;
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav>
            ...
            <a href="registro_tutores.php" class="nav-item-ae active">
    ...
    <main class="main-stage">
        ...
        <header class="reveal" style="animation-delay: 0.1s;">
            ...
            <h1 class="section-title">
                Nuevo <span class="section-accent">Tutor Académico.</span>
            </h1>
        </header>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#id_carrera').on('change', function() {
                const carreraText = $(this).find('option:selected').text().toUpperCase();
            ...
            form.on('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    text: 'Se creará un nuevo tutor académico en el sistema',
                    icon: 'question',
                    ...
                    if (result.isConfirmed) {
                        ...
                        const originalContent = btnGuardar.html();
                        btnGuardar.prop('disabled', true);
                        btnGuardar.html('<span class="spinner-border spinner-border-sm"></span> <span>Guardando...</span>');

                        // Enviar por AJAX
                        $.ajax({
                            url: 'registro_tutores.php',
                            type: 'POST',
                            data: form.serialize(),
                            dataType: 'json',
                            success: function(response) {
                                if (response.status === 'success') {
                                    ...
                                    btnGuardar.html(originalContent);
                                }
                            },
                            error: function() {
                                Swal.fire({
